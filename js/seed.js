...
// - Warm-up drills rest 30 s. Superset rest goes on the 'b' block (rest after
//   the pair); 'a' blocks flow straight into 'b' with 0 rest.
...
export const DAYS = [
  {
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 30, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Banded ankle dorsiflexion rocks', bias: L, rest: 30, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 30, t: [[B, 3, 20, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 30, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Lateral band walks', bias: null, rest: 30, t: [[B, 2, 20, null, null]] },
      { code: 'warmup', ex: 'Single-leg ankle pogo hops', bias: null, rest: 30, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Leg swings (front/back + lateral)', bias: null, rest: 30, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 30, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: '1a', ex: 'Trap bar deadlift jump-shrug', group: '1', bias: null, rest: 0, t: [[B, 5, 4, null, null]] },
      { code: '1b', ex: 'Weighted hanging knee raise', group: '1', bias: null, rest: 120, t: [[B, 4, 10, null, null]] },
      { code: '2a', ex: 'Single-leg box step-up', group: '2', bias: L, rest: 0, t: [[L, 4, 8, null, null], [R, 3, 8, null, null]] },
      { code: '2b', ex: 'Standing banded hip flexion', group: '2', bias: L, rest: 90, t: [[L, 4, 12, null, null], [R, 3, 12, null, null]] },
      { code: '3a', ex: 'KB swings', group: '3', bias: null, rest: 0, t: [[B, 4, 15, null, null]] },
      { code: '3b', ex: 'Copenhagen plank', group: '3', bias: L, rest: 90, t: [[L, 4, null, 60, null], [R, 3, null, 45, null]] },
      { code: 'knee', ex: 'ATG split squat (front foot on low board)', bias: L, rest: 60, t: [[L, 4, 8, null, null], [R, 3, 8, null, null]] },
      { code: 'knee', ex: 'Backward sled drag', bias: null, rest: 60, t: [[B, 3, null, null, 30]] },
      { code: 'knee', ex: 'Tibialis raise, loaded', bias: null, rest: 60, t: [[B, 3, 20, null, null]] },
      { code: 'power', ex: 'Heavy sled push', bias: null, rest: 150, t: [[B, 6, null, null, 20]] },
      { code: 'finisher', ex: 'Single-leg ankle pogo hops', bias: L, rest: 30, t: [[L, 3, 15, null, null], [R, 2, 15, null, null]] },
      { code: 'finisher', ex: 'Wall sit iso hold', bias: null, rest: 30, t: [[B, 2, null, 90, null]] },
      { code: 'finisher', ex: 'Standing calf raise iso hold (top)', bias: null, rest: 30, t: [[B, 2, null, 45, null]] },
    ],
  },
  {
    day_no: 2,
    ...
    blocks: [
      { code: 'warmup', ex: 'Band pull-aparts', bias: null, rest: 30, t: [[B, 1, 20, null, null]] },
      { code: 'warmup', ex: 'Band external rotation at 90° abduction', bias: null, rest: 30, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Wall slides with scapular protraction', bias: null, rest: 30, t: [[B, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Prone Y-T-W', bias: null, rest: 30, t: [[B, 1, 10, null, null]] },
      { code: 'warmup', ex: 'Doorway pec stretch', bias: null, rest: 30, t: [[L, 1, null, 90, null], [R, 1, null, 90, null]] },
      { code: 'warmup', ex: 'Side plank hip dips (QL)', bias: L, rest: 30, t: [[L, 3, 8, null, null], [R, 2, 8, null, null]] },
      { code: 'warmup', ex: 'Arm circles + cross-body swings', bias: null, rest: 30, t: [[B, 1, 12, null, null]] },
      { code: '1a', ex: 'Half-kneeling single-arm band row', group: '1', bias: L, rest: 0, t: [[L, 4, 12, null, null], [R, 3, 12, null, null]] },
      { code: '1b', ex: 'Landmine press (single arm)', group: '1', bias: L, rest: 90, t: [[L, 4, 8, null, null], [R, 3, 8, null, null]] },
      { code: '2a', ex: 'DB scaption raise', group: '2', bias: null, rest: 0, t: [[B, 4, 12, null, null]] },
      { code: '2b', ex: 'Face pulls (external rotation emphasis)', group: '2', bias: null, rest: 75, t: [[B, 4, 15, null, null]] },
      { code: '3a', ex: 'Prone trap raise', group: '3', bias: null, rest: 0, t: [[B, 4, 12, null, null]] },
      { code: '3b', ex: 'Serratus punch (banded)', group: '3', bias: null, rest: 75, t: [[L, 4, 12, null, null], [R, 4, 12, null, null]] },
      { code: 'knee', ex: 'Reverse Nordic', bias: null, rest: 60, t: [[B, 3, 8, null, null]] },
      { code: 'knee', ex: 'Tibialis raise (back to wall)', bias: null, rest: 60, t: [[B, 3, 25, null, null]] },
      { code: 'knee', ex: 'Standing calf stretch (knee bent, soleus)', bias: L, rest: 60, t: [[L, 1, null, 90, null], [R, 1, null, 60, null]] },
      { code: 'core', ex: 'Side plank with abduction', bias: R, rest: 60, t: [[R, 3, 10, null, null], [L, 2, 10, null, null]] },
      { code: 'core', ex: 'Pallof press', bias: null, rest: 60, t: [[L, 3, 12, null, null], [R, 3, 12, null, null]] },
      { code: 'core', ex: 'Pallof press iso hold', bias: null, rest: 60, t: [[L, 3, null, 60, null], [R, 3, null, 60, null]] },
      { code: 'core', ex: 'Ab roller (from knees)', bias: null, rest: 60, t: [[B, 3, 8, null, null]] },
    ],
  },
  {
    day_no: 3,
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 30, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Pallof press', bias: null, rest: 30, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 30, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 30, t: [[B, 3, 20, null, null]] },
      { code: 'warmup', ex: 'Broad jump hold-and-stick', bias: null, rest: 30, t: [[B, 1, 6, null, null]] },
      { code: 'warmup', ex: 'Depth march (low board)', bias: null, rest: 30, t: [[B, 1, 6, null, null]] },
      { code: 'warmup', ex: 'Band-resisted lateral bounds', bias: null, rest: 30, t: [[L, 1, 10, null, null], [R, 1, 10, null, null]] },
      { code: 'warmup', ex: 'Ankle pogo hops', bias: null, rest: 30, t: [[B, 1, 20, null, null]] },
      { code: '1a', ex: 'Trap bar deadlift jump-shrug', group: '1', bias: null, rest: 0, t: [[B, 5, 4, null, null]] },
      { code: '1b', ex: 'Single-leg RDL (KB)', group: '1', bias: L, rest: 120, t: [[L, 4, 10, null, null], [R, 3, 10, null, null]] },
      { code: '2a', ex: 'Depth drop into stick landing', group: '2', bias: null, rest: 0, t: [[B, 4, 4, null, null]] },
      { code: '2b', ex: 'Weighted hip flexor march', group: '2', bias: null, rest: 90, t: [[L, 4, 10, null, null], [R, 4, 10, null, null]] },
      { code: 'knee', ex: 'Nordic hamstring curl', bias: null, rest: 90, t: [[B, 4, 5, null, null]] },
      { code: 'knee', ex: 'Backward sled drag', bias: null, rest: 90, t: [[B, 3, null, null, 30]] },
      { code: 'knee', ex: 'ATG split squat (front foot on low board)', bias: L, rest: 90, t: [[L, 3, 8, null, null], [R, 2, 8, null, null]] },
      { code: '3a', ex: 'Heavy sled march', group: '3', bias: null, rest: 0, t: [[B, 6, null, null, 20]] },
      { code: '3b', ex: 'Suitcase carry', group: '3', bias: L, rest: 120, t: [[L, 3, null, null, 30], [R, 3, null, null, 30]] },
      { code: 'finisher', ex: 'Pallof press iso hold', bias: null, rest: 30, t: [[L, 3, null, 60, null], [R, 3, null, 60, null]] },
      { code: 'finisher', ex: 'Standing banded hip abduction hold', bias: R, rest: 30, t: [[R, 3, null, 60, null], [L, 2, null, 45, null]] },
    ],
  },
  {
    day_no: 4,
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 30, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Banded clamshells', bias: L, rest: 30, t: [[L, 2, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Lateral band walks', bias: null, rest: 30, t: [[B, 2, 20, null, null]] },
      { code: 'warmup', ex: 'Fire hydrant', bias: null, rest: 30, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: '90/90 hip switches', bias: null, rest: 30, t: [[B, 1, 10, null, null], [L, 1, null, 60, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Side-lying hip abduction (band)', bias: R, rest: 30, t: [[R, 2, 15, null, null], [L, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 30, t: [[B, 3, 20, null, null]] },
      { code: '1a', ex: 'Barbell hip thrust', group: '1', bias: null, rest: 0, t: [[B, 5, 8, null, null]] },
      { code: '1b', ex: 'Standing banded hip flexion', group: '1', bias: L, rest: 120, t: [[L, 4, 12, null, null], [R, 3, 12, null, null]] },
      { code: '2a', ex: 'Single-leg RDL (DB)', group: '2', bias: L, rest: 0, t: [[L, 4, 8, null, null], [R, 3, 8, null, null]] },
      { code: '2b', ex: 'Copenhagen plank', group: '2', bias: L, rest: 90, t: [[L, 4, null, 60, null], [R, 3, null, 45, null]] },
      { code: 'knee', ex: 'Banded leg curl (ankle wrap)', bias: L, rest: 60, t: [[L, 4, 15, null, null], [R, 3, 15, null, null]] },
      { code: 'knee', ex: 'Reverse Nordic', bias: null, rest: 60, t: [[B, 3, 8, null, null]] },
      { code: 'knee', ex: 'ATG split squat (front foot on low board)', bias: L, rest: 60, t: [[L, 3, 8, null, null], [R, 2, 8, null, null]] },
      { code: '3a', ex: 'Band-resisted monster walks', group: '3', bias: null, rest: 0, t: [[B, 4, 20, null, null]] },
      { code: '3b', ex: 'Single-leg glute bridge', group: '3', bias: R, rest: 75, t: [[R, 4, 12, null, null]] },
      { code: 'finisher', ex: 'Standing banded hip abduction hold', bias: R, rest: 30, t: [[R, 3, null, 60, null], [L, 2, null, 45, null]] },
      { code: 'finisher', ex: 'Glute bridge iso hold', bias: null, rest: 30, t: [[B, 3, null, 60, null]] },
      { code: 'finisher', ex: 'Couch stretch', bias: L, rest: 30, t: [[L, 1, null, 120, null]] },
    ],
  },
  {
    day_no: 0,
