...
// - Warm-up drills rest 5 s between each (Dom, 2026-08-24). The runner still
//   inserts a real MAIN REST before the first working block (runner.js
//   MAIN_REST_FLOOR) so the warm-up does not run straight into the knee work.
// - Sled push / march / backward drag carry NO distance (Dom, 2026-08-24):
//   where you drag it varies, so the prescription is sets + weight and the
//   target kind is 'effort'.
...
export const DAYS = [
  {
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 15, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Banded ankle dorsiflexion rocks', bias: L, rest: 15, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 15, t: [[B, 3, 20, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 15, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Lateral band walks', bias: null, rest: 15, t: [[B, 2, 20, null, null]] },
      { code: 'warmup', ex: 'Single-leg ankle pogo hops', bias: null, rest: 15, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Leg swings (front/back + lateral)', bias: null, rest: 15, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 15, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'knee', ex: 'Backward sled drag', bias: null, rest: 45, t: [[B, 3, null, null, null]] },
      ...
      { code: 'power', ex: 'Heavy sled push', bias: null, rest: 120, t: [[B, 6, null, null, null]] },
  ...
  },
  {
    ...
    blocks: [
      { code: 'warmup', ex: 'Band pull-aparts', bias: null, rest: 15, t: [[B, 1, 20, null, null]] },
      { code: 'warmup', ex: 'Band external rotation at 90° abduction', bias: null, rest: 15, t: [[L, 1, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Wall slides with scapular protraction', bias: null, rest: 15, t: [[B, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Prone Y-T-W', bias: null, rest: 15, t: [[B, 1, 10, null, null]] },
      { code: 'warmup', ex: 'Doorway pec stretch', bias: null, rest: 15, t: [[L, 1, null, 90, null], [R, 1, null, 90, null]] },
      { code: 'warmup', ex: 'Side plank hip dips (QL)', bias: L, rest: 15, t: [[L, 3, 8, null, null], [R, 2, 8, null, null]] },
      { code: 'warmup', ex: 'Arm circles + cross-body swings', bias: null, rest: 15, t: [[B, 1, 12, null, null]] },
  ...
  },
  {
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 15, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Pallof press', bias: null, rest: 15, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Banded hip flexor march', bias: null, rest: 15, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 15, t: [[B, 3, 20, null, null]] },
      { code: 'warmup', ex: 'Broad jump hold-and-stick', bias: null, rest: 15, t: [[B, 1, 6, null, null]] },
      { code: 'warmup', ex: 'Depth march (low board)', bias: null, rest: 15, t: [[B, 1, 6, null, null]] },
      { code: 'warmup', ex: 'Band-resisted lateral bounds', bias: null, rest: 15, t: [[L, 1, 10, null, null], [R, 1, 10, null, null]] },
      { code: 'warmup', ex: 'Ankle pogo hops', bias: null, rest: 15, t: [[B, 1, 20, null, null]] },
      { code: 'knee', ex: 'Backward sled drag', bias: null, rest: 60, t: [[B, 3, null, null, null]] },
      ...
      { code: '3b', ex: 'Heavy sled march', group: '3', bias: null, rest: 90, t: [[B, 6, null, null, null]] },
  ...
  },
  {
    ...
    blocks: [
      { code: 'warmup', ex: 'Couch stretch', bias: L, rest: 15, t: [[L, 1, null, 120, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Banded clamshells', bias: L, rest: 15, t: [[L, 2, 15, null, null], [R, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Lateral band walks', bias: null, rest: 15, t: [[B, 2, 20, null, null]] },
      { code: 'warmup', ex: 'Fire hydrant', bias: null, rest: 15, t: [[L, 1, 12, null, null], [R, 1, 12, null, null]] },
      { code: 'warmup', ex: '90/90 hip switches', bias: null, rest: 15, t: [[B, 1, 10, null, null], [L, 1, null, 60, null], [R, 1, null, 60, null]] },
      { code: 'warmup', ex: 'Side-lying hip abduction (band)', bias: R, rest: 15, t: [[R, 2, 15, null, null], [L, 1, 15, null, null]] },
      { code: 'warmup', ex: 'Tibialis raise (back to wall)', bias: null, rest: 15, t: [[B, 3, 20, null, null]] },
